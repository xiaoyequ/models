...
SQUAD_TRAIN_DATA_PATH = 'gs://tf-perfzero-data/xlnet/squadv2_cased/'
SQUAD_EVAL_DATA_PATH = 'gs://tf-perfzero-data/xlnet/squadv2_cased/12048.eval.tf_record'
SQUAD_EVAL_FEATURE_PATH = 'gs://tf-perfzero-data/xlnet/squadv2_cased/spiece.model.slen-512.qlen-64.eval.features.pkl'
...
class XLNetSquadAccuracy(XLNetBenchmarkBase):
  ...
  def __init__(self, output_dir=None, **kwargs):
    ...
    self.eval_data_path = SQUAD_EVAL_DATA_PATH
    self.eval_feature_path = SQUAD_EVAL_FEATURE_PATH
    self.pretrained_checkpoint_path = PRETRAINED_CHECKPOINT_PATH
  ...
  def _setup(self):
    ...
    FLAGS.train_tfrecord_path = self.train_data_path
    FLAGS.test_tfrecord_path = self.eval_data_path
    FLAGS.test_feature_path = self.eval_feature_path
